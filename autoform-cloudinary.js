...
_.each(templates, function(tmpl) {
  Template[tmpl].onCreated(function() {
    ...
    self.checkInitialValue = function() {
      Tracker.nonreactive(function() {
        const url = self.uploadData.get()
          ? self.uploadData.get().secure_url
          : "";
  ...
  Template[tmpl].helpers({
    props() {
      ...
      return {
        url: template.uploadData.get()
          ? template.uploadData.get().secure_url
          : "",
        id: template.uploadData.get()
          ? template.uploadData.get().public_id
          : "",
